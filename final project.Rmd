...
# Building graphs that reflect the number of facilities reporting each year
calcasieu %>% 
  group_by(REPORTING_YEAR) %>% 
  summarise(total = n()) %>% 
  ggplot(aes(x = REPORTING_YEAR, y = total)) +
  geom_col() +
  labs(title = "Calcasieu county")
