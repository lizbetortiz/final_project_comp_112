...
mean_ascension %>%  
  ...
  geom_bar(stat = "identity") +
  scale_fill_manual(name = "Names of Pollutant", values=c("#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#CC9966", "slategray1", "#006666", "#B2182B"), labels = c("Arsenic", "Benzene", "Beryllium", "Butadiene", "Cadmium", "Chromium", "Ethylene", "Formaldehyde", "Nickel Compounds", "Sulfuric", "Vinyl")) +
...
mean_calcasieu %>%  
  ggplot(aes(x = factor(REPORTING_YEAR), y = total, fill = pollutant)) +
  geom_bar(stat = "identity") +
   scale_fill_manual(name = "Names of Pollutant", values=c("#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#CC9966", "slategray1", "#006666", "#B2182B", "#9999CC", "#660066","#cc6600"), labels = c("Arsenic", "Benzene", "Beryllium", "Butadiene", "Cadmium", "Chromium", "Ethylene", "Formaldehyde", "Nickel Compounds", "Sulfuric", "Vinyl", "Asbestos", "Benzidine")) +
  labs(title = "Prevalence of Mean Pollutant Concentration (2000-2018)",
       x = "Year",
       y = "Mean Concentration") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1))
